...
namespace VideoStreamMerger
{
    class ImageControl
    {
        ...
        public ImageControl()
            : this(5, 20, 5, (float)0.95, 1, 15, 20, new TCPOut()) { }

        //methoden
        //video/webcam laden en achtergrond bepalen
        public void VideoLadenEnAchtergrondBepalen(VideoFileSource videoLinks, VideoFileSource videoRechts)
        {
            //linkervideo
        ...
        public void WebcamLadenEnAchtergrondBepalen(CaptureDevice webcamLinks, CaptureDevice webcamRechts)
        {
            //linkerwebcam
        ...
        //        socket = new TCPOut();
                ...
                while (doorgaan)
                    socket.Verzenden(ImagesSamenvoegen());
