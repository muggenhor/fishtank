...
class TexCoordArray : public AbstractArray<CoordType, CoordinateCount, supportVBO, TexCoordArray<CoordType, CoordinateCount, supportVBO> >
{
    public:
        typedef typename AbstractArray<CoordType, CoordinateCount, supportVBO, TexCoordArray<CoordType, CoordinateCount, supportVBO> >::value_type value_type;
        typedef typename AbstractArray<CoordType, CoordinateCount, supportVBO, TexCoordArray<CoordType, CoordinateCount, supportVBO> >::transform_type transform_type;

    private:
        friend class AbstractArray<CoordType, CoordinateCount, supportVBO,
               TexCoordArray<CoordType, CoordinateCount, supportVBO> >;
        ...
        {
            ar & boost::serialization::base_object< AbstractArray<CoordType, CoordinateCount, supportVBO, TexCoordArray<CoordType, CoordinateCount, supportVBO> > >(*this);
        }
};
